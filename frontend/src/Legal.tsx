...
export function Privacy() {
  return (
    <LegalShell title="Privacy Policy">
      <p>
        StratCMO is a product of <a className="maximem-link" href="https://maximem.ai" target="_blank" rel="noopener noreferrer">Maximem</a> (“we”, “us”). This policy explains what we collect, why,
...
export function Terms() {
  return (
    <LegalShell title="Terms of Service">
      <p>
        These terms govern your use of StratCMO, a product of <a className="maximem-link" href="https://maximem.ai" target="_blank" rel="noopener noreferrer">Maximem</a> (“we”, “us”). By using the service you agree to
      ...
      <ul>
        <li>You publish content under your own identity and accounts, and you’re responsible for what you post and for
          following each platform’s rules (several communities restrict self-promotion, so review every draft before posting).</li>
